...
public class KakaoOAuthStartService implements Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String redirectUri = request.getRequestURL().toString().replace("KakaoOAuthStart.do", "KakaoOAuthCallback.do");
			...
			e.printStackTrace();
			return "redirect:/login.jsp?error=카카오 로그인 초기화 실패";
		}
	}
