...
<html lang="ko">
  <head>
    ...
    <link 
      rel="stylesheet" 
      href="${pageContext.request.contextPath}/assets/css/Sl-learn.css" 
    />
  </head>
  <body>
    <div class="container">
        ...
        <section class="learning-section">
          ...
          <div class="video-containers">
            ...
            <div class="video-box">
              ...
              <video
                id="webcam"
                class="video-placeholder camera-feed"
                autoplay
                playsinline
              >
                <span>카메라 영역</span>
    ...
    <!-- [호환성] 이클립스 경로로 수정 -->
    <script 
      src="${pageContext.request.contextPath}/assets/js/Sl-learn.js"
    ></script>
  </body>
</html>
