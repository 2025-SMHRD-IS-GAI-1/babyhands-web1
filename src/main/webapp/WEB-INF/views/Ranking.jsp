...
<body>
							...
							<c:forEach var="r" items="${top5}">
								<c:choose>
									<c:when test="${r.rankNo == 1}">
										<div class="rk-row rk-top1"  data-rank="${r.rankNo}" data-id="${r.memberId}">
									...
									<c:when test="${r.rankNo == 2}">
										<div class="rk-row rk-top2" data-rank="${r.rankNo}" data-id="${r.memberId}">
									...
									<c:when test="${r.rankNo == 3}">
										<div class="rk-row rk-top3" data-rank="${r.rankNo}" data-id="${r.memberId}">
									...
									<c:otherwise>
										<div class="rk-row" data-rank="${r.rankNo}" data-id="${r.memberId}">
    ...
    <div id="loader" style="display:none; text-align:center; padding:10px;">불러오는 중...</div>
    <div id="end" style="display:none; text-align:center; padding:10px;">마지막 랭킹입니다 🎉</div>
    ...
    <input type="hidden" id="totalCount" value="${totalCount}" />
 	 ...
 	 <script>
	    ...
	    const rankingApi  = window.location.origin + contextPath + '/RankingData.do';
	 </script>
