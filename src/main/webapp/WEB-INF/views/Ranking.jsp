...
<body>
  <div class="rk-viewport"><!-- 화면 높이 기준 수직 가운데 정렬용 -->
    <div class="rk-container"><!-- header.css 와 충돌 피하려고 container -> rk-container -->
      <!-- 상단바 -->
      ...
      <div class="rk-wrapper">
        ...
        <div class="rk-board">
            ...
            <c:when test="${not empty rankList}">
              <c:forEach var="r" items="${rankList}">
                <c:choose>
                  ...
                  <c:otherwise>
                    <div class="rk-row">
                      <div class="rk-rank-num">${r.RN}</div>
                      <div class="rk-nickname">${r.NICKNAME}</div>
                      <div class="rk-score">${r.SCORE}</div>
                    </div>
                  </c:otherwise>
          ...
          <div class="rk-dots">
            <div class="rk-dot"></div><div class="rk-dot"></div><div class="rk-dot"></div>
          </div>
