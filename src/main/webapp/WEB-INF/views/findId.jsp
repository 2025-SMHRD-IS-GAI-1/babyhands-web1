...
<link rel="stylesheet" href="${ctx}/assets/css/findId.css" />
</head>
<body>
	<div class="wrap">
		<div class="card">
			...
			<form id="findIdForm">
				...
				<div class="actions">
					<button type="submit" id="findIdButton" class="btn btn-primary">아이디 찾기</button>
	...
	<script src="${ctx}/assets/js/findId.js"></script>
</body>
</html>
